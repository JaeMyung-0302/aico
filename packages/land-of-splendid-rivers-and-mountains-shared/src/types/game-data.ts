...
export interface RecipeDefinition {
  ...
  readonly ingredients: ReadonlyArray<Readonly<{ itemId: string; quantity: number }>>
...
export interface ItemDefinition {
  readonly id: string
  readonly nameKey: string
  readonly type: 'seed' | 'crop' | 'tool' | 'food' | 'material' | 'drop' | 'decoration' | 'fish' | 'gift'
...
export interface BuildingDefinition {
  ...
  readonly levels: ReadonlyArray<{
    ...
    readonly materials: ReadonlyArray<{ readonly itemId: string; readonly quantity: number }>
...
export interface EventDefinition {
  ...
  readonly type: 'festival' | 'harvest' | 'seasonal'
  readonly rewards: ReadonlyArray<Readonly<{ itemId: string; quantity: number }>>
  readonly goldReward: number
}

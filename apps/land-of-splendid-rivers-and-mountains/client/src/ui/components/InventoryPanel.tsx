...
const getIconPath = (itemId: string): string => {
  ...
  const fileName = prefix && itemId.startsWith(prefix) ? itemId.slice(prefix.length) : itemId
    ...
    <div style={styles.panel}>
      ...
      <div style={styles.grid}>
        {Array.from({ length: TOTAL_SLOTS }, (_, i) => {
          ...
          const isEquipped = slot !== null && slot.itemId === equippedTools.current
            ...
            >
              {slot && (
                <>
                  ...
                  />
                  <span style={styles.itemLabel}>{getItemName(slot.itemId)}</span>
                  {slot.quantity > 1 && (

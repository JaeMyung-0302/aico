...
describe('InventoryService', () => {
  ...
  describe('equipItem', () => {
    it('should throw NotFoundException when item not found', async () => {
      ...
      await expect(
        service.equipItem('user-1', 'eq-1', 'char-1'),
  ...
  describe('unequipItem', () => {
    it('should throw NotFoundException when item not found', async () => {
      ...
      await expect(service.unequipItem('user-1', 'eq-1')).rejects.toThrow(
        NotFoundException,
      )
    })
  ...
  describe('sellItem', () => {
    it('should throw NotFoundException when item not found', async () => {
      ...
      await expect(service.sellItem('user-1', 'eq-1')).rejects.toThrow(
        NotFoundException,
      )
    })

        ...
        {CONNECTIONS.map(([from, to]) => {
          ...
          return (
            <line
              ...
              y2={cb.y}
              stroke={
                isActive ? "rgba(255,255,255,0.45)" : "rgba(255,255,255,0.15)"
              }
              strokeWidth={1.5}
          ...
          return (
            <g key={scene.key} filter={isCurrent ? "url(#glow)" : undefined}>
              <rect
                ...
                stroke={
                  isCurrent ? "rgba(255,255,255,0.9)" : "rgba(255,255,255,0.1)"
                }
              ...
              {isCurrent && (
                <circle cx={x + CELL - 4} cy={y + 4} r={2} fill="#4ade80">
                  <animate
...
const styles: Record<string, React.CSSProperties> = {
  container: {
    background:
      "linear-gradient(135deg, rgba(20,25,40,0.75), rgba(10,15,25,0.85))",
    borderRadius: 8,

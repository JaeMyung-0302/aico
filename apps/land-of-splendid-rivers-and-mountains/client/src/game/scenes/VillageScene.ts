...
export class VillageScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    this.systemManager = new SystemManager(['lod', 'time-weather', 'energy', 'npc', 'fermentation', 'building', 'animal', 'combat'])
  ...
  private createTilesetTexture(): void {
    ...
    const canvas = this.textures.createCanvas('tileset-village', size * 2, size * 2)
    if (!canvas) return

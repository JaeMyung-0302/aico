    ...
    <div style={styles.container}>
      <div style={styles.topBar}>
        ...
        <div style={styles.leftCol}>
          ...
          {reputation > 0 && (
            <div style={styles.barRow}>
              <span style={{ ...styles.barLabel, color: "#a855f7" }}>RP</span>
              <div style={styles.barBg}>
                <div
                  style={{
                    ...styles.barFill,
              ...
              <span style={styles.barText}>{reputation}</span>
            </div>
          )}
        </div>
        ...
        <div style={styles.centerCol}>
          ...
          <div style={styles.dateRow}>
            ...
            <span
              style={{ ...styles.seasonBadge, backgroundColor: seasonColor }}
            >
              {t(`ui.season.${season}`)}
            </span>
          </div>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  topBar: {
    ...
    padding: "6px 8px",
    background:
      "linear-gradient(180deg, rgba(0,0,0,0.65) 0%, rgba(0,0,0,0.25) 85%, transparent 100%)",
  },
  leftCol: {
    display: "flex",

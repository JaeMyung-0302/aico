...
export const ENTITY_SPRITE_ASSETS = {
  ...
  boss:       { path: '/assets/sprites/monster/boss.png',   frameWidth: 64, frameHeight: 64, frameCount: 1 },
...
export const NPC_SPRITE_ASSETS: Record<NpcType, SpriteAssetConfig> = {
  shop:         { path: '/assets/sprites/npc/shop.png',         frameWidth: 64, frameHeight: 96, frameCount: 1 },
  blacksmith:   { path: '/assets/sprites/npc/blacksmith.png',   frameWidth: 64, frameHeight: 96, frameCount: 1 },
  portal_guide: { path: '/assets/sprites/npc/portal_guide.png', frameWidth: 48, frameHeight: 80, frameCount: 1 },
}

// 장애물 스프라이트 설정 (맵 데이터의 spriteType 키로 참조)
export const OBSTACLE_SPRITE_ASSETS: Record<string, SpriteAssetConfig> = {
  tree_01:  { path: '/assets/sprites/obstacle/tree_01.png',  frameWidth: 32, frameHeight: 48, frameCount: 1 },
  tree_02:  { path: '/assets/sprites/obstacle/tree_02.png',  frameWidth: 32, frameHeight: 48, frameCount: 1 },
  rock_01:  { path: '/assets/sprites/obstacle/rock_01.png',  frameWidth: 32, frameHeight: 32, frameCount: 1 },
  fountain: { path: '/assets/sprites/obstacle/fountain.png', frameWidth: 48, frameHeight: 48, frameCount: 1 },
  grass:    { path: '/assets/sprites/obstacle/grass.png',    frameWidth: 24, frameHeight: 16, frameCount: 1 },
}
...
export const BACKGROUND_ASSETS: Record<MapId, BackgroundAssetConfig> = {
  ...
  serpent_forest: { path: '/assets/sprites/background/serpent_forest.png', tileSize: 128 },
  ice_cave:       { path: '/assets/sprites/background/ice_cave.png',       tileSize: 128 },
  flame_castle:   { path: '/assets/sprites/background/flame_castle.png',   tileSize: 128 },
}

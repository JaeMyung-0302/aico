...
const SideBySide = ({ size }: { size: number }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
    ...
    <rect x="10" y="6" width="12" height="36" rx="2" fill="#d4eaf8" opacity="0.5" />
    <rect x="26" y="6" width="12" height="36" rx="2" fill="#e8edf5" opacity="0.5" />
    <rect x="21" y="14" width="2" height="12" rx="1" fill="#8890a0" />
    <rect x="25" y="14" width="2" height="12" rx="1" fill="#8890a0" />
    <text x="16" y="16" fontSize="5" fill="#7090b0" textAnchor="middle" fontWeight="600">❄</text>
    <text x="32" y="16" fontSize="5" fill="#70a070" textAnchor="middle" fontWeight="600">🌿</text>
  </svg>
)
...
const FourDoor = ({ size }: { size: number }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
    ...
    <rect x="10" y="6" width="12" height="17" rx="2" fill="#e8edf5" opacity="0.5" />
    <rect x="26" y="6" width="12" height="17" rx="2" fill="#e8edf5" opacity="0.5" />
    <rect x="10" y="27" width="12" height="15" rx="2" fill="#e8f0e0" opacity="0.5" />
    <rect x="26" y="27" width="12" height="15" rx="2" fill="#d4eaf8" opacity="0.5" />

      ...
      <div style={overlayStyle}>
        ...
        {screen === 'game' && (
          <>
            ...
            {!dialogOpen && <GameTabBar activeTab={activeTab} onTabChange={handleTabChange} />}
          </>
        )}
        <SettingsPanel visible={settingsOpen} onClose={() => setSettingsOpen(false)} />
        <SaveLoadScreen visible={saveLoadOpen} onClose={() => setSaveLoadOpen(false)} onLoad={handleStart} />
      </div>
    </div>
  )
}

...
export const createEliteGeometry = (): BufferGeometry => {
  const parts: BufferGeometry[] = [
    ...
    part(
      new BoxGeometry(1.5, 1, 1.2),
      -3,
      HEAD_MID + 1,
      HEAD_R,
      ELITE_COLORS.eyesInner,
    ),
    part(
      new BoxGeometry(1.5, 1, 1.2),
      3,
    ...
    part(
      new BoxGeometry(BODY_W + 1, 2, BODY_D + 1),
      0,
      BODY_MID,
      0,
      ELITE_COLORS.bodyDetail,
    ),
    // Shoulders
    part(
    ...
    // Arms
    part(
      new BoxGeometry(ARM_W, ARM_H, ARM_D),
      -(BODY_W / 2 + ARM_W / 2),
      ARM_MID,
      0,
      ELITE_COLORS.arm,
    ...
    // Legs
    part(
      new BoxGeometry(LEG_W, LEG_H, LEG_D),
      -BODY_W / 4,
      LEG_MID,
      0,
      ELITE_COLORS.leg,

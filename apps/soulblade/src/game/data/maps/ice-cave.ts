...
export const ICE_CAVE_MAP: WorldMapConfig = {
  ...
  obstacles: [
    // 종유석 (collidable)
    { x: 400, y: 650, width: 35, height: 50, color: 0x88ccff, type: 'triangle', collidable: true, spriteType: 'rock_01' },
    { x: 900, y: 750, width: 40, height: 55, color: 0x88ccff, type: 'triangle', collidable: true, spriteType: 'rock_01' },
    { x: 1400, y: 900, width: 35, height: 50, color: 0x88ccff, type: 'triangle', collidable: true, spriteType: 'rock_01' },
    { x: 1100, y: 2600, width: 35, height: 50, color: 0x88ccff, type: 'triangle', collidable: true, spriteType: 'rock_01' },
    // 빙하 (collidable)
    { x: 700, y: 1100, width: 80, height: 40, color: 0x6699cc, type: 'rect', collidable: true, alpha: 0.7, spriteType: 'rock_01' },
    { x: 300, y: 1500, width: 70, height: 35, color: 0x6699cc, type: 'rect', collidable: true, alpha: 0.7, spriteType: 'rock_01' },
    // 얼음 결정 (not collidable)
    { x: 500, y: 900, width: 25, height: 30, color: 0xaaddff, type: 'triangle', collidable: false, alpha: 0.5, spriteType: 'grass' },
    { x: 1100, y: 1300, width: 20, height: 25, color: 0xaaddff, type: 'triangle', collidable: false, alpha: 0.5, spriteType: 'grass' },
    { x: 200, y: 1800, width: 25, height: 30, color: 0xaaddff, type: 'triangle', collidable: false, alpha: 0.5, spriteType: 'grass' },
    { x: 400, y: 400, width: 20, height: 25, color: 0xaaddff, type: 'triangle', collidable: false, alpha: 0.5, spriteType: 'grass' },
    { x: 1900, y: 2800, width: 25, height: 30, color: 0xaaddff, type: 'triangle', collidable: false, alpha: 0.5, spriteType: 'grass' },

...
import type { CreateFoodItemInput, UpdateFoodItemInput } from '../types/index.js'
...
foodItemRouter.get('/compartments/:compartmentId/food-items', async (req: Request, res: Response): Promise<void> => {
  try {
...
foodItemRouter.post('/compartments/:compartmentId/food-items', async (req: Request, res: Response): Promise<void> => {
...
foodItemRouter.put('/food-items/:id', async (req: Request, res: Response): Promise<void> => {
...
foodItemRouter.delete('/food-items/:id', async (req: Request, res: Response): Promise<void> => {
  try {
...
foodItemRouter.patch('/food-items/:id/move', async (req: Request, res: Response): Promise<void> => {
